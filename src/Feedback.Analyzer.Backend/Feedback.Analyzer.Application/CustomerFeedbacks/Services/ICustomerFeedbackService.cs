...
public interface ICustomerFeedbackService
{
    ...
    /// <summary>
    /// Retrieves a queryable collection of customer feedback entities based on the provided filter and query options.
    /// </summary>
    /// <param name="customerFeedbackFilter">The filter to apply to the customer feedback entities.</param>
    /// <param name="queryOptions">Query options for sorting, pagination, etc.</param>
    /// <returns>A queryable collection of customer feedback entities.</returns>
    IQueryable<CustomerFeedback> Get(CustomerFeedbackFilter customerFeedbackFilter, QueryOptions queryOptions = default);

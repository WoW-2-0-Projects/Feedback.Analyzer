...
public class ExecutePromptEventHandler(IFeedbackPromptExecutionOrchestrationService executionOrchestrationService)
    : IEventHandler<ExecutePromptEvent>
{
    ...
    {
        await executionOrchestrationService.ExecuteAsync(notification.ExecutionContext, cancellationToken);
    }
}
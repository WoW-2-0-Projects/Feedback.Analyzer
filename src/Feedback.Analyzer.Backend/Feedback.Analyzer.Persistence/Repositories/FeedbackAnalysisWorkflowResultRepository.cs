...
public class FeedbackAnalysisWorkflowResultRepository(AppDbContext dbContext)
    : EntityRepositoryBase<FeedbackAnalysisWorkflowResult, AppDbContext>(dbContext), IFeedbackAnalysisWorkflowResultRepository
{

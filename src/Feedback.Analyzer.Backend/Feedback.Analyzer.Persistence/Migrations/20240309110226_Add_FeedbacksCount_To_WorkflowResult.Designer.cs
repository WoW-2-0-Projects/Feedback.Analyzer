...
namespace Feedback.Analyzer.Persistence.Migrations
{
    ...
    [Migration("20240309110226_Add_FeedbacksCount_To_WorkflowResult")]
    partial class Add_FeedbacksCount_To_WorkflowResult
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Feedback.Analyzer.Domain.Entities.FeedbackAnalysisWorkflow", b =>
                {
                    b.HasOne("Feedback.Analyzer.Domain.Entities.WorkflowExecutionOptions", "EntryExecutionOption")
                        ...
                        .HasForeignKey("Feedback.Analyzer.Domain.Entities.FeedbackAnalysisWorkflow", "EntryExecutionOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

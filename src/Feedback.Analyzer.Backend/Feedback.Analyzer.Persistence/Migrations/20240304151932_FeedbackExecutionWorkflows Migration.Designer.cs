...
namespace Feedback.Analyzer.Persistence.Migrations
{
    ...
    [Migration("20240304151932_FeedbackExecutionWorkflows Migration")]
    partial class FeedbackExecutionWorkflowsMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Feedback.Analyzer.Domain.Entities.WorkflowPromptCategoryExecutionOptions", b =>
                {
                    ...
                    b.HasKey("FeedbackExecutionWorkflowId", "AnalysisPromptCategoryId");

                    b.HasIndex("AnalysisPromptCategoryId");

                    b.ToTable("WorkflowPromptCategoryExecutionOptions", (string)null);
                });
            ...
            modelBuilder.Entity("Feedback.Analyzer.Domain.Entities.WorkflowPromptCategoryExecutionOptions", b =>
                {
                    b.HasOne("Feedback.Analyzer.Domain.Entities.AnalysisPromptCategory", null)
                        .WithMany()
                        .HasForeignKey("AnalysisPromptCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Feedback.Analyzer.Domain.Entities.FeedbackExecutionWorkflow", null)
                        .WithMany()

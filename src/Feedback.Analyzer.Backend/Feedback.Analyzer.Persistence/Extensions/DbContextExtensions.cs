...
internal static class DbContextExtensions
{
    ...
    internal static void ApplyEntityConfigurations<TDataContext>(this ModelBuilder modelBuilder) where TDataContext : DbContext
    {
    ...
    internal static IList<Type> GetEntityTypes(Type dbContextType)
    {
    ...
    /// </returns>
    internal static IList<Type> GetEntityConfigurations(Type dbContextType)
    {
